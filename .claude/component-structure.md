...
// ✗ WRONG - Don't combine both prefixes
function handleOnSubmit() { ... }; // Use handleSubmit (parent implementation) or onSubmit (prop name)
```
...
- [ ] Callback props use `on` prefix, parent implementations use `handle` prefix
